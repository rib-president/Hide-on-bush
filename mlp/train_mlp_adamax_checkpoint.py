...
callbacks_list = [ModelCheckpoint(save_path + '/checkpoint-{epoch:04d}.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='auto'), EarlyStopping(monitor='val_loss', patience=50, verbose=0)]
