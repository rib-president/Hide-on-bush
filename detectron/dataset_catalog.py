...
_DATASETS = {
    ...
    'nobrand_train': {
        _IM_DIR:
            _DATA_DIR + '/nobrand_new/nobrand_train',
        _ANN_FN:
            _DATA_DIR + '/nobrand_new/instances_shape_nobrand_new_train.json'
    },
    'nobrand_val': {
        _IM_DIR:
            _DATA_DIR + '/nobrand_new/nobrand_val',
        _ANN_FN:
            _DATA_DIR + '/nobrand_new/instances_shape_nobrand_new_val.json'
    }
}
