...
def train(train_data_dir, validation_data_dir, model_path):  
    ...
    top_weights_path = os.path.join(os.path.abspath(model_path), 'top_model_weights_finetune.h5')
    callbacks_list = [
        ModelCheckpoint(top_weights_path, monitor='val_acc', verbose=1, save_best_only=True),
        EarlyStopping(monitor='val_acc', patience=20, verbose=0),
    ...
    # save weights of best training epoch: monitor either val_loss or val_acc
    final_weights_path = os.path.join(os.path.abspath(model_path), 'model_weights_finetune.h5')
    callbacks_list = [
    ...
    with open(os.path.join(os.path.abspath(model_path), 'model_weights_finetune.json'), 'w') as json_file:
